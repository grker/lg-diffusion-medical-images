...
python src/main.py project_name=dmiise validation_period=10 trainer.max_epochs=300 dataloader.batch_size=128 dataloader.val_batch_size=128 diffusion=sample_diffusion dataset=acdc diffusion.repetitions=1 diffusion.repetitions_test=1 model.name=basic_unet metrics=metrics_handler_multi loss=x_0_pred_loss dataset.data_path=data/ACDC
