...
python src/loss_guidance.py run_id=uxqy4vz3 loss_guidance=loss_guidance_3step loss_guidance/guider=seg_comp_digits loss_guidance.guider.name=LossGuiderSegmenationCyclesDigits loss_guidance.starting_step=5 loss_guidance.gamma=0.1 test_batch_size=16 loss_guidance.visualize_gradients=False loss_guidance.mode=dps_guidance metrics=metrics_handler_binary_guidance
# python src/test.py
