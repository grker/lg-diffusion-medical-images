...
python src/loss_guidance.py run_id=2piyzfrk loss_guidance=loss_guidance_3step loss_guidance.guider.name=LossGuiderSegmentationComponentsDigits loss_guidance.starting_step=5 loss_guidance.gamma=100 test_batch_size=32 loss_guidance.visualize_gradients=False loss_guidance.mode=dps_guidance
# python src/test.py
