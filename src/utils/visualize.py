...
def visualize_mean_variance(ensemble_mask: torch.Tensor, phase: str, batch_idx: int, class_wise:bool=True, index_list:list[int]=None):
    ...
    if class_wise:
        ...
        raise NotImplementedError("Non-class-wise variant for multiple classes not yet implemented")


def visualize_mean_variance_class_wise(ensemble_mask: torch.Tensor, phase: str, batch_idx: int, num_classes: int):
